...
if __name__ == "__main__":
    ...
    if os.path.isfile("fedavg_results.csv"): 
        results.to_csv("fedavg_results.csv", mode="a", index=False, header=False)
    else:
        results.to_csv("fedavg_results.csv", mode="a", index=False, header=True)